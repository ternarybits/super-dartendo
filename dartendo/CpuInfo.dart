...
class CpuInfo {
    ...
    // Opdata array:
    static List<int> opdata;
    // Instruction names:
    static List<String> instname;
    // Address mode descriptions:
    static List<String> addrDesc;
    static List<int> cycTable;
    // Instruction types:
    // -------------------------------- //
    ...
    static final int INS_BMI = 7;
    static final int INS_BNE = 8;
    static final int INS_BPL = 9;
    static final int INS_BRK = 10;
    static final int INS_BVC = 11;
    static final int INS_BVS = 12;
    static final int INS_CLC = 13;
    static final int INS_CLD = 14;
    static final int INS_CLI = 15;
    static final int INS_CLV = 16;
    static final int INS_CMP = 17;
    static final int INS_CPX = 18;
    static final int INS_CPY = 19;
    static final int INS_DEC = 20;
    static final int INS_DEX = 21;
    static final int INS_DEY = 22;
    static final int INS_EOR = 23;
    static final int INS_INC = 24;
    static final int INS_INX = 25;
    static final int INS_INY = 26;
    static final int INS_JMP = 27;
    static final int INS_JSR = 28;
    static final int INS_LDA = 29;
    static final int INS_LDX = 30;
    static final int INS_LDY = 31;
    static final int INS_LSR = 32;
    static final int INS_NOP = 33;
    static final int INS_ORA = 34;
    static final int INS_PHA = 35;
    static final int INS_PHP = 36;
    static final int INS_PLA = 37;
    static final int INS_PLP = 38;
    static final int INS_ROL = 39;
    static final int INS_ROR = 40;
    static final int INS_RTI = 41;
    static final int INS_RTS = 42;
    static final int INS_SBC = 43;
    static final int INS_SEC = 44;
    static final int INS_SED = 45;
    static final int INS_SEI = 46;
    static final int INS_STA = 47;
    static final int INS_STX = 48;
    static final int INS_STY = 49;
    static final int INS_TAX = 50;
    static final int INS_TAY = 51;
    static final int INS_TSX = 52;
    static final int INS_TXA = 53;
    static final int INS_TXS = 54;
    static final int INS_TYA = 55;
    static final int INS_DUMMY = 56; // dummy instruction used for 'halting' the processor some cycles
    // -------------------------------- //
    // Addressing modes:
    static final int ADDR_ZP = 0;
    static final int ADDR_REL = 1;
    static final int ADDR_IMP = 2;
    static final int ADDR_ABS = 3;
    static final int ADDR_ACC = 4;
    static final int ADDR_IMM = 5;
    static final int ADDR_ZPX = 6;
    static final int ADDR_ZPY = 7;
    static final int ADDR_ABSX = 8;
    static final int ADDR_ABSY = 9;
    static final int ADDR_PREIDXIND = 10;
    static final int ADDR_POSTIDXIND = 11;
    static final int ADDR_INDABS = 12;

    static List<int> getOpData() {
        if (opdata == null) {
            initOpData();
        }
        return opdata;
    ...
    static List<String> getInstNames() {
        if (instname == null) {
            initInstNames();
        }
        return instname;
    ...
    static List<String> getAddressModeNames() {
        if (addrDesc == null) {
            initAddrDesc();
        }
        return addrDesc;
