...
public class VNESAboutBox extends javax.swing.JDialog {

    public VNESAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
  ...
  private void initComponents() {
    ...
    org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(vnes.VNESApp.class).getContext().getResourceMap(VNESAboutBox.class);
    setTitle(resourceMap.getString("title")); // NOI18N
    setModal(true);
    setName("aboutBox"); // NOI18N
    setResizable(false);

    javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(vnes.VNESApp.class).getContext().getActionMap(VNESAboutBox.class, this);
